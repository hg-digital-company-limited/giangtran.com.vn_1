<div class="sidebar-wrapper" data-sidebar-layout="stroke-svg">
    <div>
        <div class="logo-wrapper"><a href="/" wire:navigate><img loading="lazy" class="img-fluid" src="/logo/giangtran.com.vn.png"
                    style="height: 40px;" alt=""></a>
            <div class="back-btn"><i class="fa fa-angle-left"></i></div>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
        </div>
        <div class="logo-icon-wrapper"><a href="/" wire:navigate><img loading="lazy" class="img-fluid" src="/logo/icon.png"
        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="/" wire:navigate><img loading="lazy" class="img-fluid" src="/logo/icon.png"
                                width="35px;" alt=""></a>
