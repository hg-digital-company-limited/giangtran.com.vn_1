<div class="modal fade" id="exampleModalbalancebox" tabindex="-1" role="dialog" aria-labelledby="exampleModalbalancebox"
    aria-modal="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="card-body">
                                ...
                                <li>
                                    <div class="balance-item danger">
                                        ...
                                        <label class="form-check-label" for="radio14">
                                            <div> <span class="f-12 f-light" style="white-space: nowrap;"> Số Dư Tài
                                                    Khoản
                                                </span> <span
                                                    class="f-w-600">{{ number_format($balance) }}<sup>đ</sup></span>
                                                <div style="display: flex">
                                                    ...
                                                    @else
                                                        <span class="badge badge-light-success rounded-pill"
                                                            id="badge_radio14_scc" style=" "> Khả Dụng </span>
                                                    @endif
                                                    <input class="form-check-input" id="radio14" type="radio"
                                                        wire:model="paymentMethod" value="balance" checked>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                        ...
                        <div class="mt-4">
                            <span> Tổng Thanh Toán: <strong class="text-danger"><span
                                        id="amount-total">{{ number_format($sourceCodeDetail->price) }}</span><sup>VND</sup>
                                    <sup id="discount-show"></sup></strong></span>

                            <div class="checkbox p-0">
                                <input id="dieuKhoan" type="checkbox" checked>
                                <label class="text-muted" for="dieuKhoan"> Đồng Ý Với </label> <a href="/dieu-khoan"
                                    class="txt-primary"> Điều Khoản Sử Dụng Dịch
                                    Vụ </a>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6 col-6">
                                    <span class="badge badge-danger text-white"
                                        style="width: 100%; padding: 10px; cursor: pointer;" data-bs-dismiss="modal"
                                        aria-label="Close"><i class="icofont icofont-close"></i> Hủy </span>
                                </div>
        ...
        <script>
            window.addEventListener('showModalPaymentSourceCode', (e) => {
                $("#exampleModalbalancebox").modal('show');
            });
            window.addEventListener('closeModalPaymentSourceCode', (e) => {
                $("#exampleModalbalancebox").modal('hide');
            });
        </script>
</div>
